...
- (void)viewDidLoad {
    ...
    self.payload.string = @"{\"aps\":{\"alert\":\"This is some fancy message.\",\"badge\":6,\"sound\": \"default\",\"mutable-content\":1,\"content-available\":1}}";
...
- (IBAction)payLoadButtonTouched:(NSPopUpButton*)sender {
    ...
    switch (sender.indexOfSelectedItem) {
        case 1:
            ...
            break;
        case 2:
            stringValue = @"{\"aps\":{\"alert\":\"This is some fancy message.\",\"badge\":1}}";
            break;
        case 3:
            stringValue = @"{\"aps\":{\"alert\":\"This is some fancy message.\",\"badge\":2,\"sound\": \"default\"}}";
            break;
        default:
            stringValue = @"{\"aps\":{\"alert\":\"This is some fancy message.\",\"badge\":3,\"sound\": \"default\"}}";
            break;
